...
const switchVariants = cva(
  "peer inline-flex shrink-0 cursor-pointer items-center rounded-full border-2 transition-colors duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 focus-visible:ring-offset-background disabled:cursor-not-allowed disabled:opacity-50",
  {
    variants: {
      variant: {
        primary: "peer-checked:bg-white peer-checked:border-white",
          ...
          >
            ...
            <div
              className={cn(
                ...
                isChecked && variant === "primary" && "text-white",
              ...
              {shouldRenderIcons && (
                <div className="relative w-full h-full flex items-center justify-center overflow-hidden">
                    ...
                    <div className={cn(
                        ...
                        isChecked ? "opacity-100 scale-100 rotate-0 text-white" : "opacity-0 scale-50 -rotate-45"
                    )}>
                        {checkedIcon ? (
                             checkedIcon
                        ) : (
                    ...
                    <div className={cn(
                        "absolute inset-0 flex items-center justify-center transition-all duration-300 text-black",
            ...
            <div 
                className={cn(
                    ...
                    isChecked 
                      ? (variant === 'destructive' ? "bg-destructive" : "bg-black") 
                      : "bg-white",
